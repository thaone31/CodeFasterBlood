...
rf = Roboflow(api_key="LG563r2OZX7vtlIUiUne")
project = rf.workspace("bloodcell-lpovu").project("combined_data-wkt2d")
dataset = project.version(8).download("voc")

# defining the files directory and testing directory
files_dir = '../Combine_Data-8/train'
test_dir = '../Combine_Data-8/test'
...
class FruitImagesDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, files_dir, width, height, transforms=None):
        ...
        self.classes = [_, 'basophil','neutrophil','eosinophil','monocyte','lymphocyte','platelets']
